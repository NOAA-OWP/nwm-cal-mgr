...
class AdjustableCatchment(FormulatableCatchment, Adjustable):
    ...
    def __init__(self, workdir: "Path", id: str, nexus, params: dict = {}):
        ...
        """
        FormulatableCatchment.__init__(
            self=self, catchment_id=id, params=params, outflow=nexus
        )
        Adjustable.__init__(
    ...
    def output(self) -> "DataFrame":
        ...
        try:
            self._output = read_csv(
                self._output_file,
                usecols=["Time", self._output_var],
                parse_dates=["Time"],
                index_col="Time",
                dtype={self._output_var: "float64"},
            )
...
class CalibrationCatchment(AdjustableCatchment, EvaluatableCatchment):
    ...
    def __init__(
        ...
        EvaluatableCatchment.__init__(
            self, nexus, start_time, end_time, fabric, output_var, eval_params
        )
